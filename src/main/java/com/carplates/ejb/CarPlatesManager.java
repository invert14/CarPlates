...
public class CarPlatesManager {
    ...
    public List<CarPlate> getCarPlates() {
        ...
        Query q = entityManager.createQuery("select c from CarPlate c");
...
//        }
    ...
    public CarPlate getCarPlateById(Long id) {
        ...
        Query q = entityManager.createQuery("select c from CarPlate c where c.id=:id");
    ...
    public void persist(CarPlate carPlate) {
        Query q = entityManager.createQuery("select r from RegistrationAuthority r");
